export const data = {
  ...
  info: [
    {
      text: [
        `This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.theknottyones.com (the “Site”).`,
      ],
    },
    {
      titleBlock: 'PERSONAL INFORMATION WE COLLECT',
      text: [
    ...
    {
      titleBlock: 'HOW DO WE USE YOUR PERSONAL INFORMATION?',
      text: [
    ...
    {
      titleBlock: 'SHARING YOUR PERSONAL INFORMATION',
      text: [
    ...
    {
      titleBlock: 'BEHAVIOURAL ADVERTISING',
      text: [
    ...
    {
      titleBlock: 'DO NOT TRACK',
      text: [
        `Please note that we do not alter our Site’s data collection and use practices when we see a Do Not Track signal from your browser.`,
      ],
    },
    {
      titleBlock: 'YOUR RIGHTS',
      text: [
